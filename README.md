...
[![Go Reference](https://pkg.go.dev/badge/github.com/plar/genai.svg)](https://pkg.go.dev/github.com/plar/genai)
...
Add the SDK to your module with `go get github.com/plar/genai`.

## Create Clients

### Imports
```go
import "github.com/plar/genai"
```
